...
export const GitHubCopilotSettings = makeProviderSettingsSchema(
  {
    ...
    homePath: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        ...
        description: "Custom Copilot home directory for auth, config, and session state.",
        providerSettingsForm: {
          placeholder: "~/.copilot",
          clearWhenEmpty: "omit",
        },
...
export const GeminiSettings = makeProviderSettingsSchema(
  {
    ...
    homePath: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        ...
        description: "Custom Gemini CLI home directory for auth, config, and session state.",
        providerSettingsForm: {
          placeholder: "~/.gemini-t3/personal",
          clearWhenEmpty: "omit",
        },
      }),
    ),
