// This file mostly exists because we want dev mode to say "DGM Agent (Dev)" instead of "electron"
...
const APP_DISPLAY_NAME = isDevelopment ? "DGM Agent (Dev)" : "DGM Agent (Alpha)";
