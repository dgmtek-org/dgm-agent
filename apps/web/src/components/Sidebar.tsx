...
function AppLogoMark() {
  return (
    ...
    >
      <path fill="#3b82f6" d="M93.68,0,73.43,20.25H20.25V73.42L0,93.67V15A15,15,0,0,1,15,0Z" />
      <path fill="#3b82f6" d="M108,14.32V93a15,15,0,0,1-15,15H14.32L34.57,87.75H87.75V34.57Z" />
    </svg>
  );
}
